...
| Haferflocken | Backwaren & Getreide | g | — | C522000 | Getreideflakes gesüßt | Haferschmelzflocken, Hafer, Oats | 348 | KORREKTUR NÖTIG: BLS hat keine reinen "Haferflocken" als eigenen Eintrag in den Treffern. Bitte prüfen — es gibt evtl. einen anderen Code (Haferflocken sollten ~370 kcal/100g, kein Zucker). Siehe "Nicht gefunden" unten. | |
